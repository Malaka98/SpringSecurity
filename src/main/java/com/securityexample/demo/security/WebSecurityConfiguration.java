...
import com.securityexample.demo.security.filter.CustomAuthenticationFilter;
import com.securityexample.demo.security.filter.CustomAuthorizationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/", "/api/login/**", "/api/log").permitAll();
